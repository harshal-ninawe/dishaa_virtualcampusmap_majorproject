    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-slate-950/85 backdrop-blur-md">
        ...
        <motion.div
          ...
          className="relative w-full max-w-4xl glass-panel rounded-3xl border border-white/20 shadow-[0_0_60px_rgba(56,189,248,0.35)] bg-slate-900/95 overflow-hidden flex flex-col max-h-[92vh] z-10"
        >
          {/* Top Modal Header */}
          <div className="p-4 sm:p-5 border-b border-white/10 flex items-center justify-between bg-slate-900/90 shrink-0">
            <div className="flex items-center gap-3">
              <div className="relative w-10 h-10 rounded-2xl bg-gradient-to-br from-blue-600 via-cyan-500 to-indigo-600 flex items-center justify-center shadow-[0_0_15px_rgba(56,189,248,0.5)]">
                {selectedRole === 'faculty' ? <Users className="w-5 h-5 text-white" /> : <Shield className="w-5 h-5 text-white" />}
              </div>
              <div>
                <h3 className="font-extrabold text-base sm:text-lg text-white tracking-wide">
                  DISHAA Admin & Faculty Portal
                </h3>
                <p className="text-xs text-cyan-400 font-mono">
                  {isAuthenticated
                    ? `Logged in as ${loggedInUser?.role.toUpperCase()}: ${loggedInUser?.name}`
                    : 'Select Portal Role to Sign In & Manage Locations'}
                </p>
              </div>
            </div>
          ...
          <div className="p-4 sm:p-6 overflow-y-auto flex-1 min-h-0 space-y-6">
            ...
            {!isAuthenticated ? (
              <>
                ...
                <div className="p-1 rounded-2xl bg-slate-950 border border-white/10 grid grid-cols-2 gap-1">
                  <button
                    type="button"
                    ...
                    className={`py-3 px-4 rounded-xl font-bold text-xs sm:text-sm flex items-center justify-center gap-2 transition-all cursor-pointer ${
                      selectedRole === 'faculty'
                        ? 'bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow-[0_0_15px_rgba(56,189,248,0.5)]'
                  ...
                  <button
                    ...
                    className={`py-3 px-4 rounded-xl font-bold text-xs sm:text-sm flex items-center justify-center gap-2 transition-all cursor-pointer ${
                      selectedRole === 'admin'
                        ? 'bg-gradient-to-r from-cyan-500 to-indigo-600 text-white shadow-[0_0_15px_rgba(99,102,241,0.5)]'
                        : 'text-slate-400 hover:text-white hover:bg-white/5'
                    }`}
                  >
                ...
                {selectedRole === 'faculty' && (
                  <div className="space-y-5">
                    ...
                    {facultySubMode === 'login' && (
                      <form onSubmit={handleFacultyAuth} className="space-y-4 max-w-md mx-auto py-2">
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full py-2.5 pl-10 pr-3 rounded-xl bg-slate-950 border border-white/15 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400"
                            />
                          </div>
                        </div>
                        ...
                        <div className="space-y-1">
                          ...
                          <div className="relative">
                            ...
                            <input
                              ...
                              placeholder="••••••••"
                              className="w-full py-2.5 pl-10 pr-10 rounded-xl bg-slate-950 border border-white/15 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-cyan-400"
                            />
                            <button
                              type="button"
                        ...
                        <button
                          ...
                          className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-blue-600 via-cyan-500 to-emerald-500 text-white font-extrabold text-sm shadow-[0_0_20px_rgba(56,189,248,0.6)] hover:scale-[1.01] disabled:opacity-50 transition-all flex items-center justify-center gap-2 cursor-pointer border border-white/20"
                        >
                          <LogIn className="w-5 h-5" />
                          <span>{isSubmitting ? 'Authenticating with MongoDB...' : 'Sign In to Faculty Portal'}</span>
                        </button>
                    ...
                    {facultySubMode === 'register' && (
                      <form onSubmit={handleFacultyAuth} className="space-y-4">
                        <div className="p-3 rounded-2xl bg-emerald-950/30 border border-emerald-500/30 text-xs text-emerald-200 flex items-center gap-2">
                          ...
                          <span>Register your account & sitting location to MongoDB Atlas (`dishaadb.faculties`).</span>
                        </div>
                          ...
                          <div className="space-y-1">
                            ...
                            <div className="relative">
                              ...
                              <input
                                ...
                                className="w-full py-2.5 pl-10 pr-3 rounded-xl bg-slate-950 border border-white/15 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-emerald-400"
                              />
                            </div>
                          </div>
                          ...
                          <div className="space-y-1">
                            ...
                            <div className="relative">
                              ...
                              <input
                                ...
                                className="w-full py-2.5 pl-10 pr-10 rounded-xl bg-slate-950 border border-white/15 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-emerald-400"
                              />
                              <button
                                type="button"
                                onClick={() => setShowFacultyPassword(!showFacultyPassword)}
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div className="space-y-1">
                              ...
                              <select
                                ...
                                className="w-full py-2 px-2.5 rounded-xl bg-slate-900 border border-white/15 text-xs text-white focus:border-emerald-400"
                              >
                            ...
                            <div className="space-y-1">
                              <label className="text-[10px] font-mono text-slate-400 uppercase">Room No. *</label>
                              <input
                                type="text"
                                required
                                value={facultyRoomNo}
                                ...
                                className="w-full py-2 px-3 rounded-xl bg-slate-900 border border-white/15 text-xs text-white placeholder-slate-500 focus:border-emerald-400"
                              />
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          ...
                          <span>{isSubmitting ? 'Registering to MongoDB Atlas...' : 'Register Account & Save Sitting Location'}</span>
                        </button>
                ...
                {selectedRole === 'admin' && (
                  <form onSubmit={handleAdminLogin} className="space-y-4 max-w-md mx-auto py-2">
                    <div className="p-3 rounded-2xl bg-indigo-950/30 border border-indigo-500/30 text-xs text-indigo-200 flex items-center gap-2">
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full py-2.5 pl-10 pr-3 rounded-xl bg-slate-950 border border-white/15 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-indigo-400"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="••••••••"
                          className="w-full py-2.5 pl-10 pr-10 rounded-xl bg-slate-950 border border-white/15 text-xs text-white placeholder-slate-500 focus:outline-none focus:border-indigo-400"
                        />
                        <button
                          type="button"
                    ...
                    <button
                      type="submit"
                      className="w-full py-3.5 rounded-2xl bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-500 text-white font-extrabold text-sm shadow-[0_0_20px_rgba(99,102,241,0.6)] hover:scale-[1.01] transition-all flex items-center justify-center gap-2 cursor-pointer border border-white/20"
                    >
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-2xl glass-card border border-cyan-500/30 bg-slate-950/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-400 to-cyan-600 text-slate-950 flex items-center justify-center font-extrabold text-lg shadow-[0_0_15px_rgba(52,211,153,0.5)]">
                      {loggedInUser?.name.charAt(0)}
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        <h4 className="font-extrabold text-base text-white">{loggedInUser?.name}</h4>
                      ...
                      <p className="text-xs text-slate-300 mt-0.5">{loggedInUser?.department}</p>
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-xl bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 text-red-300 text-xs font-bold transition-colors flex items-center gap-2 cursor-pointer shrink-0"
                  >
                ...
                <div className="p-1 rounded-2xl bg-slate-950 border border-white/10 grid grid-cols-2 sm:grid-cols-4 gap-1">
                  <button
                  ...
                  <button
                    ...
                    className={`py-2.5 px-3 rounded-xl font-bold text-xs sm:text-sm flex items-center justify-center gap-2 transition-all cursor-pointer ${
                      dashboardTab === 'host-event'
                        ? 'bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-[0_0_15px_rgba(52,211,153,0.5)]'
                        : 'text-slate-400 hover:text-white hover:bg-white/5'
                    }`}
                  >
